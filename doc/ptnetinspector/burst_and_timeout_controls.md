# Burst and Timeout controls
This file states variables and parameters that control specific timeouts and burst sizes.
...
|send/send_ipv4.py|SendIPv4|send_reverse_ipv4_MDNS_batch|rsp_timeout|0.3|
...
|send/send_ipv6.py|SendIPv6|send_reverse_ipv6_MDNS_batch|rsp_timeout|0.3|
|utils/address_control.py|AddressValidator|-|__timeout|0.5|
